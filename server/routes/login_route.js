...
const {LoginController,SignUpController,demoController,LogOutController,EmailVerificationController,CheckOtpValidContoller, ResetPasswordController, GoogleSignInController} = require("../controllers/auth_controller.js")  
...
router.route("/reset-pass/:email").post(ResetPasswordController) ;
