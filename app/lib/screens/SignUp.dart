             ...
             Padding(
              ...
              Form( 
                ...
                MaterialPageRoute(builder: (context) => Login()) 
                          ...
                          child: Text("already have an account",style: TextStyle(decoration: TextDecoration.underline  , backgroundColor: Colors.transparent),)),
                      )
                     ],
                    ) ,
                         Padding(
                ...
                MaterialPageRoute(builder: (context) => Login()) 
                  ...
                  borderRadius: BorderRadius.circular(30.0)
                   ...
                   child: Center(child: Text("Sign-up Here",style: TextStyle(color: Colors.white,fontSize: 16.0),)),
                  ),
                ),
                            ) ,
                             Padding(
