...
class SignUp extends StatelessWidget {
  final GlobalKey<FormState> _keyForm = GlobalKey(debugLabel: "signup key");

  final _google_image_uri =
                        ...
                        child: TextFormField(
                          ...
                          validator: (value) {
                            if ((value!.length) > 6) {
                              ...
                              return "username should b at least 6 char";
                            }
                          },
                      ...
                      child: InkWell(
                        ...
                        onTap: () {
                          if (_keyForm.currentState!.validate()) {
                            print(_emailController.text.trim().toString());
                            print(_usernameController.text.trim().toString());
                            print(_passwordController.text.trim().toString()); 

                            BlocProvider.of<AuthBloc>(context).add(AuthSignUpRequest(username: _usernameController.text.trim().toString() ,
                        ...
                        child: Container(
                          ...
                          child: Center(
                            child: BlocConsumer<AuthBloc, AuthState>(
                              ...
                              builder: (_, state) {
                                return state is SignUpLoading && state.loading == true ?
                                Center(
