...
class Login extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    final AuthBloc res = BlocProvider.of<AuthBloc>(context);

    return Scaffold(
      backgroundColor: Colors.white,

      body: BlocListener<GoogleAuth, GoogleCubitState>(
        listener: (_, state) {
          if (state is GoogleAuthAuccess) {
                              ...
                              child: InkWell(
                                ...
                                onTap: () async {
                                  final googleSignIn = GoogleSignIn(
                                    scopes: ['email'],
                                    clientId:
                                        '1002263384663-4nfrccuut41mpmvs0u5dn83g4sukhk0q.apps.googleusercontent.com',
                                  );
                                ...
                                child: Container(
                                  child:
                                      BlocBuilder<GoogleAuth, GoogleCubitState>(
                                        builder: (_, state) {
